...
pbPhysicsListMessenger::pbPhysicsListMessenger(pbPhysicsList* pPhys)
:pPhysicsList(pPhys)
{   
  physDir = new G4UIdirectory("/pb/phys/");
  physDir->SetGuidance("physics control.");

  gammaCutCmd = new G4UIcmdWithADoubleAndUnit("/pb/phys/setGCut",this);  
  ...
  electCutCmd = new G4UIcmdWithADoubleAndUnit("/pb/phys/setECut",this);  
  ...
  protoCutCmd = new G4UIcmdWithADoubleAndUnit("/pb/phys/setPCut",this);  
  ...
  allCutCmd = new G4UIcmdWithADoubleAndUnit("/pb/phys/setCuts",this);
  ...
  eCutCmd = new G4UIcmdWithADoubleAndUnit("/pb/phys/TargetCuts",this);
  ...
  mCutCmd = new G4UIcmdWithADoubleAndUnit("/pb/phys/DetectorCuts",this);
  ...
  pListCmd = new G4UIcmdWithAString("/pb/phys/SelectPhysics",this);
...
pbPhysicsListMessenger::~pbPhysicsListMessenger()
{
  delete physDir;
  delete gammaCutCmd;
  delete electCutCmd;
...
void pbPhysicsListMessenger::SetNewValue(G4UIcommand* command,
                                          G4String newValue)
{
